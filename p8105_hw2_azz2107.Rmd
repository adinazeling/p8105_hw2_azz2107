...
The BRFSS dataset contains information on how individuals in the United States rated their overall health on a scale of poor to excellent. This dataset has `r nrow(brfss_df)` observations and `r ncol(brfss_df)`. Surveys were taken in `r nrow(distinct(brfss_df, locationdesc))` distinct locations within the United States. Of these locations, `r nrow(distinct(brfss_df, locationabbr))` states including Washington D.C. were included. In 2002, the median of the "Excellent" response value was `r median(filter(brfss_df, year == 2002)$excellent, na.rm = TRUE)`%. 
